...
import com.totoro.core.utils.DBManager;
import com.totoro.core.utils.DateHelper;
  ...
  public String invoke()
  {
    ...
    case 4:
      ...
      try {
    	  ...
    	  fileinfo.setFileName(a.get("title").toString());
    	  fileinfo.setOriginalName(a.get("original").toString());
    	  fileinfo.setFileType(a.get("type").toString().substring(1));
    	  fileinfo.setFileUrl(a.get("url").toString().substring(1));
    	  fileinfo.setFileSize(Integer.parseInt(a.get("size").toString()));
    	  fileinfo.setUploadTime(new Date());
    	  fileinfo.setTableUuid(tableid);
    	  uploadfileService.saveUploadInfo(fileinfo);*/
