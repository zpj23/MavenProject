package com.totoro.es.utils;

import com.totoro.es.dao.Dao;
...
public class EsUtils {
    ...
    public static final String CLUSTER_NAME = "totoro";
    public static final String HOST_IP = "192.168.117.135";
