package com.totoro.core.utils.tag;
...
public class FileUploadTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		buffer.append("<script type=\"text/javascript\" id=\""+id+"\" >baidufile.init('"+mode+"','"+moduleID+"','"+id+"');</script>");
		try {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	...
        	buffer.append("<div name=\""+id+"\" id=\""+id+"\" style=\"height:0px;width:32px;\"   onclick=\"aa('"+moduleID+"')\" ></div>");
        	if(!"view".equals(mode)){
