...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	<input type="text" value="" id="searchName"  placeholder="维修人的名称" class="layui-input search_input">
		    </div>
		    <div class="layui-input-inline">
		    	<input type="text" value="" id="starttime"   placeholder="开始日期" class="layui-input search_input">
		    </div>
		    ~
		    <div class="layui-input-inline">
		    	<input type="text" value="" id="endtime"   placeholder="结束日期" class="layui-input search_input">
		    </div>
	...
	<script type="text/javascript" src="${ctx}/js/maintain/list.js"></script>
